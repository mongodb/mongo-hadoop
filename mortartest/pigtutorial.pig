...
STORE raw INTO 'mongodb://tmillar:mortartest@ds033097.mongolab.com:33097/mortardb.pig' USING com.mongodb.hadoop.pig.MongoStorage('update [time, servername, hostname]', '{time : 1, servername : 1, hostname : 1}, {unique:false, dropDups: false}');
-- STORE ordered_uniq_frequency INTO 'out.log' USING PigStorage('\t');
