...
public class MongoTool extends Configured implements Tool {
     ...
     **/
    protected String jobName = "<unnamed MongoTool job>";
    ...
    public int run(String[] args) throws Exception {
        ...
        log.info("Created a conf: '" + conf + "' on {" + this.getClass() + "} as job named '" + jobName + "'");
        ...
        Class mapper = MongoConfigUtil.getMapper(conf);
