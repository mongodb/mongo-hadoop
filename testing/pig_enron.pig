...
REGISTER ../core/target/mongo-hadoop-core_cdh4.3.0-1.1.0-SNAPSHOT.jar
REGISTER ../pig/target/mongo-hadoop-pig_cdh4.3.0-1.1.0-SNAPSHOT.jar

--raw = LOAD 'file:///Users/mike/dump/enron_mail/messages.bson' using com.mongodb.hadoop.pig.MongoLoader('','headers:[]') ; 
