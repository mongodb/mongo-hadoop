...
/**
 * <p>Contains utility methods to parse the ip database file and other utility methods</p> <p>TODO: eliminate code
 * duplication with CsvReader</p>
 *
...
public class IpCsvParser {
    ...
    public final static Pattern patt =
            Pattern.compile( "\"(\\d+)\",\"(\\d+)\",\"(\\w+)\",\"(\\d+)\",\"(\\w+)\",\"(\\w+)\",\"(.+)\"" );
