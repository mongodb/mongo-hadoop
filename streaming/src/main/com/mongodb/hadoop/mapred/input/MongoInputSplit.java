...
public class MongoInputSplit implements Writable, InputSplit {
    ...
    DBCursor getCursor(){
        ...
        final DBCursor cursor =
                MongoConfigUtil.getCollection( _mongoURI ).find( _querySpec, _fieldSpec ).sort( _sortSpec );
        log.debug( "Cursor: " + cursor );
        log.info( "getCursor(collection: " + cursor.getCollection() + ", id: " + cursor.getCursorId() + ", addr: "
